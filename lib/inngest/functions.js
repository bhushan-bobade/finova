...
//This is also called as Event Batching
...
function isTransactionDue(transaction) {
    ...
    const nextDue = new Date(transaction.nextRecurringData);
...
const getMonthlyStats = async(userId, month) => {
    ...
    const endDate = new Date(month.getFullYear(), month.getMonth() + 1, 0); // + 1 for Next Month
